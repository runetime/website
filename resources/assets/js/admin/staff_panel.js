...
var StaffPanel = (function () {
    function StaffPanel() {
        ...
        $(this.hooks.mute.send).click(function (e) {
            staffPanel.sendMute();
        });
        $(this.hooks.report.send).click(function (e) {
            staffPanel.sendReport();
        });
        this.setup();
    }
    StaffPanel.prototype.error = function (error) {
        if (results.error === -1) {
    ...
    StaffPanel.prototype.sendMute = function () {
        var data = {
    ...
    StaffPanel.prototype.sendReport = function () {
        var data = {
    ...
    StaffPanel.prototype.setup = function () {
